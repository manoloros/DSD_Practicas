...
main (int argc, char **argv)
{
	...
	pmap_unset (CALCULADORA, PRIMERA);
	...
	if (!svc_register(transp, CALCULADORA, PRIMERA, calculadora_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (CALCULADORA, PRIMERA, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, CALCULADORA, PRIMERA, calculadora_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (CALCULADORA, PRIMERA, tcp).");
		exit(1);
	}
